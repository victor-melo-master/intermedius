...
class CatalogosBaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Tipos de operación
        $tipos = [
            ['codigo' => 'venta_usd',       'nombre' => 'Venta de USD',        'afecta_cliente' => true,  'afecta_fifo' => true,  'genera_ganancia' => false],
            ['codigo' => 'compra_usd',      'nombre' => 'Compra de USD',       'afecta_cliente' => true,  'afecta_fifo' => true,  'genera_ganancia' => true],
