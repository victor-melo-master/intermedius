...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('clientes', function (Blueprint $table) {
            ...
            $table->decimal('saldo_cache_usd', 20, 2)->default(0);
        ...
        Schema::create('cuentas', function (Blueprint $table) {
            ...
            $table->decimal('saldo_cache', 20, 2)->default(0);
            $table->timestamp('saldo_cache_at')->nullable();
            $table->boolean('activa')->default(true);
            $table->text('notas')->nullable();
            $table->timestamps();
        ...
        Schema::create('operaciones', function (Blueprint $table) {
            ...
            $table->decimal('monto_comision', 20, 2)->default(0);
            ...
            $table->decimal('ganancia_bruta_usd', 20, 2)->default(0);
            $table->decimal('ganancia_real_usd', 20, 2)->nullable();
            $table->decimal('ganancia_bruta_ves', 20, 2)->default(0);
            $table->decimal('ganancia_real_ves', 20, 2)->nullable();
            $table->decimal('total_comisiones_usd', 20, 2)->default(0);
            $table->decimal('total_comisiones_ves', 20, 2)->default(0);
            $table->decimal('ganancia_neta_usd', 20, 2)->default(0);
        ...
        Schema::create('movimientos', function (Blueprint $table) {
            ...
            $table->decimal('monto_usd_equivalente', 20, 2);
