  ...
  <div :class="flat ? 'space-y-4' : 'bg-white border border-edge rounded-xl p-5 space-y-4'">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div>
        ...
        <div class="flex gap-2 items-start">
          ...
          <button
            ...
            type="button"
            @click="limpiarMonto"
            class="shrink-0 px-2.5 h-[42px] bg-surface-muted hover:bg-danger-soft hover:text-danger text-ink-soft rounded-xl text-xs font-medium transition active:scale-[0.98] flex items-center gap-1"
      ...
      <div>
        ...
        <p v-if="tasaSugerida" class="text-xs text-ink-faint mt-1">
    ...
    <div>
      ...
      <div class="relative">
        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-ink-faint text-sm">{{ quoteSimbolo }}</span>
        <input
