<template>
  <div class="min-h-screen bg-surface-alt flex items-center justify-center p-4">
    <div class="bg-surface rounded-2xl shadow-lg p-8 text-center max-w-sm w-full border border-edge">
      ...
      <div v-if="loading" class="text-ink-soft">Verificando...</div>
      <div v-else-if="success" class="text-success">
        ...
        <p class="text-sm text-ink-soft mt-2">Ya puedes iniciar sesión.</p>
      ...
      <div v-else class="text-danger">
        ...
        <p class="text-sm text-ink-soft mt-2">{{ error || 'El enlace de verificación es inválido o ha expirado.' }}</p>
