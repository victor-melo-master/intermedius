  ...
  <div class="min-h-screen bg-gray-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-lg p-8 text-center max-w-sm w-full">
      ...
      <div v-else-if="success" class="text-green-600">
        <div class="text-4xl mb-4"><Iconoir name="check" class="w-10 h-10 text-green-500" /></div>
      ...
      <div v-else class="text-red-600">
        <div class="text-4xl mb-4"><Iconoir name="x-mark" class="w-10 h-10 text-red-500" /></div>
